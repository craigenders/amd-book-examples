# EXAMPLE 9.8 - Bayes Regression w MNAR Pattern Mixture Model
...
# pattern mixture model with missing data pattern mean difference
analysis1 <- rblimp(
    data = drugtrial,
...
# pattern mixture model with missing data pattern mean difference + moderation
analysis2 <- rblimp(
  data = drugtrial,
  ordinal = 'male drug dropout',
  center = 'severity0 male',
