# EXAMPLE 9.6 - Bayes Regression w MNAR Selection Model
...
# dv as only predictor in missingness model
analysis1 <- rblimp(
  data = drugtrial,
  ordinal = 'dropout',
  fixed = 'male drug',
  ...
  model = '
      ...
      predictor.model: severity0 ~ drug male; # sequential specification for incomplete predictor 
...
# dv + treatment as predictors in missingness model
analysis2 <- rblimp(
    data = drugtrial,
    ordinal = 'dropout',
    fixed = 'male drug',
